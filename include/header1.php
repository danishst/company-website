            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="pull-right">
                        <ul class="list-inline">
                            <a href="https://m.facebook.com/sagartechsolns/" target="_blank"><li class="list-inline-item"><i class="fa fa-facebook text-white"></i></li></a>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <ul class="menu-links">
                            <!-- active class -->
                            <li <?php echo ($page == 'home') ? 'class=active' : ''; ?>><a href="/">Home</a>
                            </li>
